...
mod tests {
    ...
    use up_rust::{
        ...
        core::usubscription::{
            ...
            USubscription, UnsubscribeRequest, UnsubscribeResponse,
        },
    ...
    async fn test_subscribe(topic: UUri, state: State) {
        ...
        if test_lib::helpers::local_usubscription_service_uri().is_remote_authority(&topic) {
            let expected_remote_uri = UUri {
                ...
                ue_id: usubscription_uris::USUBSCRIPTION_SERVICE_ID,
                ue_version_major: usubscription_uris::USUBSCRIPTION_SERVICE_VERSION_MAJOR,
                resource_id: usubscription_uris::UP_SUBSCRIBE_ID as u32,
                ..Default::default()
            };
        ...
        let usubscription = USubscriptionService::new(
            None,
    ...
    async fn test_unsubscribe(topic: UUri) {
        ...
        if test_lib::helpers::local_usubscription_service_uri().is_remote_authority(&topic) {
            let expected_remote_uri = UUri {
                ...
                ue_id: usubscription_uris::USUBSCRIPTION_SERVICE_ID,
                ue_version_major: usubscription_uris::USUBSCRIPTION_SERVICE_VERSION_MAJOR,
                resource_id: usubscription_uris::UP_UNSUBSCRIBE_ID as u32,
                ..Default::default()
            };
            let expected_call_options = CallOptions::for_rpc_request(
                crate::UP_REMOTE_TTL,
