...
mod tests {
    ...
    use std::str::FromStr;
    use up_rust::core::usubscription::Subscription;

    use up_rust::{
        core::usubscription::FetchSubscriptionsResponse, core::usubscription::Request, UStatus,
        UUri,
    };

    use super::*;
    use crate::usubscription;
    use crate::{helpers, tests::test_lib, usubscription_uris::*};
    ...
    async fn test_fetch_subscriptions_success() {
        ...
        let fetch_subscriptions_uri = UUri {
            ...
            resource_id: UP_FETCH_SUBSCRIPTIONS_ID as u32,
            ..Default::default()
        };
